...
| 35-60 | Demo GV: team **2 agent** (không phải 3) trên `tai-lieu-phat/demo/buoi-05/du-an-ra-mat-san-pham/` |
| 60-70 | Nghỉ |
...
```
Trong thư mục tai-lieu-phat/demo/buoi-05/du-an-ra-mat-san-pham/ có 3 thư mục con.
...
| 2 | **Subagent không hỏi lại người dùng được** | `buoi-04-subagent.md` dòng 76, `mau-cau-hinh/agent-report-mau.md` dòng 31 | Bỏ "hỏi tối đa 3 câu trước khi soạn". Thay bằng: vẫn soạn đủ, chỗ thiếu ghi [đợi bổ sung], câu cần hỏi gom cuối bản dưới mục "Cần chủ quản xác nhận" |
