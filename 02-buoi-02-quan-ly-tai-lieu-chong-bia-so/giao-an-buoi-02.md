...
- [ ] Mở sẵn thư mục demo: `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/`
- [ ] File demo cần dùng:
  - `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/bao-cao-tong-ket-nam-2026.docx` (14 trang, dùng cho phần demo GV)
  - `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/hop-dong-dich-vu-mau.md` (dùng cho thực hành học viên)
...
- [ ] Mẫu cấu hình liên quan: `07-mau-cau-hinh-linh-kien/skill-tom-tat-tai-lieu.md` (KHÔNG chiếu cho lớp ở phần demo, chỉ dùng để đối chiếu cuối buổi hoặc cấp cho học viên bị tụt lại)
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/bao-cao-tong-ket-nam-2026.docx`
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** không cần file demo cho bước này (đang tạo file cấu hình). GV giữ `07-mau-cau-hinh-linh-kien/skill-tom-tat-tai-lieu.md` bên cạnh để đối chiếu, nhưng KHÔNG chiếu lên trước khi lớp thấy skill tự sinh ra.
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/hop-dong-dich-vu-mau.md`
...
- Logo CES: `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/logo-ces.png`
- Bộ nhận diện CES: `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/bo-nhan-dien-ces.md` (navy 1B3285, đỏ C0392B, teal 009898, vàng C47F0A).
...
- **Prompt cho lớp (bản chỉ rõ đường dẫn để chạy được ngay, GV chiếu bản này cho học viên copy):**
  ...
  ```
- **File demo:** `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/logo-ces.png` và `02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/bo-nhan-dien-ces.md`; nội dung lấy từ file `.md` ở Lượt 1.
...
| Lượt 2 logo không hiện trong file                                                      | Sai đường dẫn logo hoặc agent quên chèn. Nhắc: "Chèn logo 02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/logo-ces.png vào header mỗi trang." Kiểm file logo có nằm đúng chỗ không. |
...
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| 1      | `Tóm tắt giúp tôi báo cáo trong 02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/bao-cao-tong-ket-nam-2026.docx`                                                                | (chưa thành mục nào, đây là lượt để lớp thấy chưa đủ) |
...
| 7 | `Tóm tắt hợp đồng trong 02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/hop-dong-dich-vu-mau.md`                                         | `hop-dong-dich-vu-mau.md` | Chỉ 1 lượt ra đủ 5 mục; bóc đúng 120 triệu, 2 đợt 50/50, 12 tháng, phạt 0,05%/ngày, bảo mật 2 năm |
...
| TH3-2  | `Tổng hợp nội dung báo cáo vừa rồi thành 1 file docx... logo 02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/logo-ces.png... tone màu bo-nhan-dien-ces.md... tiếng Việt đủ dấu, UTF-8`            | `logo-ces.png`, `bo-nhan-dien-ces.md` | File docx có logo header, màu navy/teal/vàng, tiếng Việt đủ dấu, không ô vuông                |
...
| Claude báo không tìm thấy file hợp đồng                                          | Sai đường dẫn. Kiểm tra file có nằm trong thư mục dự án không, gõ lại đúng đường dẫn`02-buoi-02-quan-ly-tai-lieu-chong-bia-so/demo/hop-dong-dich-vu-mau.md`.                                            |
