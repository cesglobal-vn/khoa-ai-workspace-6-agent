...
- [ ] Mở sẵn thư mục demo: `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/`
...
- [ ] Mẫu cấu hình liên quan: `07-mau-cau-hinh-linh-kien/mcp-cau-hinh-mau.md`
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/` (cả thư mục)
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/doanh-thu-quy.csv`
...
- **Prompt gợi ý cho học viên:**
  ...
  ```
- **File demo:** `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/don-hang.csv`
- **Kết quả mong đợi (đối chiếu số thật):**
