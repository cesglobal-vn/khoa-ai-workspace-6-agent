...
Thư mục mẫu: `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/`. Có **8 file** nằm trong **5 thư mục con**. GV nên mở sẵn cây thư mục này lên màn hình từ đầu buổi.
...
- `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-claude-md-ca-nhan.md`
- `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-claude-md-phong-kinh-doanh.md`
- `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-00-index-hoan-chinh.md`
...
- [ ] Mẫu mở sẵn: `07-mau-cau-hinh-linh-kien/claude-md-profile-va-cau-truc-phong-ban.md`
- [ ] Mở sẵn cây thư mục `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/` trên màn hình
- [ ] File demo phụ: `01-buoi-01-ai-workspace-claude-code/demo/bien-ban-hop-mau.md`
...
- **PROMPT P1, bản GV dán chạy ngay:**
  ```
  Viết giúp tôi email nhắc khách An Phát thanh toán, dựa trên 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/01-khach-hang/an-phat.md
  ```
...
- **File demo:** `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/01-khach-hang/an-phat.md`
...
- **File demo:** mẫu đối chiếu `07-mau-cau-hinh-linh-kien/claude-md-profile-va-cau-truc-phong-ban.md` phần 2. Bản đã điền đầy đủ: `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-claude-md-ca-nhan.md`
...
- **File demo:** cấu trúc mẫu 5 phòng ban ở `07-mau-cau-hinh-linh-kien/claude-md-profile-va-cau-truc-phong-ban.md` phần 3. Bản đã điền đầy đủ cho phòng Kinh doanh: `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-claude-md-phong-kinh-doanh.md`
...
- **PROMPT P4b, bản GV dán chạy ngay:**
  ```
  Trong thư mục 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/ có những gì? Kể cho tôi nghe từng file chứa nội dung gì.
  ```
...
- **PROMPT P5, bản GV dán chạy ngay:**
  ```
  Đọc toàn bộ thư mục 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/ kể cả các thư mục con, rồi tạo file 00-index.md ngay tại gốc thư mục đó. Liệt kê mỗi file một dòng: tên file và một câu mô tả nội dung. Nhóm theo thư mục con, mỗi thư mục con là một bảng riêng. Đừng bỏ sót file nào.
  ```
...
- **PROMPT P5, bản học viên:**
  ...
  ```
  *Gợi ý điền:* dán đúng đường dẫn thư mục phòng ban bạn vừa tạo ở P4. Thư mục còn trống chưa có file thì dùng tạm đường dẫn bộ demo `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/`.

- **File demo:** `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/`. Bản đã điền đầy đủ: `03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/vi-du-00-index-hoan-chinh.md`
...
- **PROMPT P5b, bản GV dán chạy ngay:**
  ```
  Đọc 00-index.md của thư mục 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/ trước, rồi trả lời: khách nào đang có đơn hàng quá hạn thanh toán, số tiền bao nhiêu, đã nhắc mấy lần và vào ngày nào?
  ```
...
- **PROMPT P7, bản GV dán chạy ngay:**
  ```
  Tôi vừa thêm file mới vào thư mục 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/. Đọc lại toàn bộ thư mục kể cả thư mục con, rồi cập nhật 00-index.md: thêm dòng cho file mới, giữ nguyên các dòng cũ còn đúng, bỏ dòng nào trỏ tới file không còn tồn tại.
  ```
...
- **Việc GV làm trước khi chạy P7:** copy file `bien-ban-hop-mau.md` từ `01-buoi-01-ai-workspace-claude-code/demo/` vào `phong-kinh-doanh-mau/05-bao-cao/`. Làm ngay trên màn hình cho lớp thấy.
...
- **PROMPT P7b, bản GV dán chạy ngay:**
  ```
  Đọc hai file trong 03-buoi-03-phan-tich-du-lieu-mcp-routine/demo/phong-kinh-doanh-mau/04-so-lieu/ và trả lời gọn:
