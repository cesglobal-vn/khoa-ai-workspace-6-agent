...
> (3) FILE DEMO: đường dẫn file trong `04-tai-lieu-phat/demo/` dùng cho prompt đó,
...
- [ ] Mở sẵn thư mục demo: `04-buoi-04-lap-bao-cao-va-slide/demo/`
- [ ] File demo cần dùng: `so-lieu-ban-hang-thang.md`, `yeu-cau-nghien-cuu.md`
- [ ] Mẫu cấu hình liên quan: `07-mau-cau-hinh-linh-kien/agent-report-mau.md`, `07-mau-cau-hinh-linh-kien/agent-research-mau.md`
...
- Nội dung trình chiếu, mở file mẫu `07-mau-cau-hinh-linh-kien/agent-report-mau.md` cho lớp nhìn cấu trúc thật:
...
- **Prompt gõ vào Claude Code:**
  ...
  ```
- **File demo:** dùng nội dung mẫu ở `07-mau-cau-hinh-linh-kien/agent-report-mau.md` để đối chiếu file agent vừa tạo.
...
- **Prompt gõ vào Claude Code:**
  ```
  Nhờ report-agent soạn báo cáo bán hàng tháng 3 dựa trên số liệu trong file 04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md.
  Báo cáo cần có các mục: kết quả tháng 3, số liệu chính, vướng mắc, kế hoạch tháng 4.
  Không được bịa thêm con số nào ngoài file.
  ```
- **File demo:** `04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md`
...
- **Prompt gõ vào Claude Code:**
  ```
  Từ file 04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md, hãy soạn giúp một báo cáo bán hàng tháng 3 hoàn chỉnh theo văn phong công sở.
  ```
- **File demo:** `04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md`
...
- **Prompt gợi ý cho học viên (bước giao việc):**
  ```
  Nhờ research-agent làm theo yêu cầu trong file 04-buoi-04-lap-bao-cao-va-slide/demo/yeu-cau-nghien-cuu.md.
  Trả về báo cáo có tóm tắt điều hành, bảng so sánh đối thủ, và tách rõ chỗ nào là dữ kiện chỗ nào cần kiểm chứng thêm.
  ```
- **File demo:** `04-buoi-04-lap-bao-cao-va-slide/demo/yeu-cau-nghien-cuu.md` (đối chiếu mẫu ở `07-mau-cau-hinh-linh-kien/agent-research-mau.md`)
...
|---|---|---|---|
| 1 | Tạo file `.claude/agents/report-agent.md` với YAML name/description/tools (Read, Write, Grep, Glob) và thân dặn không bịa số, không emoji | `07-mau-cau-hinh-linh-kien/agent-report-mau.md` (đối chiếu) | File agent đúng cấu trúc, tools không có công cụ web |
| 2 | Nhờ report-agent soạn báo cáo bán hàng tháng 3 từ file số liệu | `04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md` | Báo cáo 4 mục (kết quả, số liệu, vướng mắc, kế hoạch), số đúng file, không emoji, không bịa |
| 3 | Soạn giúp báo cáo bán hàng (không gọi tên agent) | `04-buoi-04-lap-bao-cao-va-slide/demo/so-lieu-ban-hang-thang.md` | Lead tự gọi report-agent nhờ description khớp |
| 4 | Tạo file `.claude/agents/research-agent.md`, tools có thêm WebSearch, WebFetch | `07-mau-cau-hinh-linh-kien/agent-research-mau.md` (đối chiếu) | File agent có công cụ web, thân yêu cầu tách dữ kiện với suy luận |
| 5 | Nhờ research-agent làm theo `yeu-cau-nghien-cuu.md` | `04-buoi-04-lap-bao-cao-va-slide/demo/yeu-cau-nghien-cuu.md` | Báo cáo có tóm tắt điều hành, bảng so sánh đối thủ, phần cần kiểm chứng |
